...
class WorkpaperController extends BaseController{
    ...
    */
    ...
    /**
        ...
        * @return redirect-to-page
    */
    public function saverceap($code,$c3tID,$cID,$wpID,$name){
    ...
    */
    ...
    /**
        ...
        * @return redirect-to-page
    */
    public function saveaa4($code,$c3tID,$cID,$wpID,$name){
    ...
    */
    ...
    public function save311($code,$c3tID,$cID,$wpID,$name){
    ...
    public function viewpdfc3($code,$c3tID,$cID,$wpID){
        ...
        switch ($code) {
            ...
            case '3.14 Ab3':
                ...
                break; 
            case '3.15 Ab4':
                $rdata = $this->wpmodel->getvalues_sc3('checklist',$code,$dc3tID,$dcID,$dwpID);
                $data['sec']    = json_decode($rdata['question'], true);
                $data['sec1']   = $this->wpmodel->getvalues_mc3('section1',$code,$dc3tID,$dcID,$dwpID);
                $data['sec2']   = $this->wpmodel->getvalues_mc3('section2',$code,$dc3tID,$dcID,$dwpID);
                $data['sec3']   = $this->wpmodel->getvalues_mc3('section3',$code,$dc3tID,$dcID,$dwpID);
                $data['sec4']   = $this->wpmodel->getvalues_mc3('section4',$code,$dc3tID,$dcID,$dwpID);
                $data['sec5']   = $this->wpmodel->getvalues_mc3('section5',$code,$dc3tID,$dcID,$dwpID);
                $data['sec6']   = $this->wpmodel->getvalues_mc3('section6',$code,$dc3tID,$dcID,$dwpID);
                $data['sec7']   = $this->wpmodel->getvalues_mc3('section7',$code,$dc3tID,$dcID,$dwpID);
                $data['sec8']   = $this->wpmodel->getvalues_mc3('section8',$code,$dc3tID,$dcID,$dwpID);
                $data['sec9']   = $this->wpmodel->getvalues_mc3('section9',$code,$dc3tID,$dcID,$dwpID);
