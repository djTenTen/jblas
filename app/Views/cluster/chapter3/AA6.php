        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="m-5">
                    ...
                    <form action="<?= base_url()?>auditsystem/cluster/savevalues/c3/saveaa7aepapp/<?= $code?>/<?= $mtID?>/<?= $cID?>/<?= $name?>" method="post">
                    ...
                    <form action="<?= base_url()?>auditsystem/cluster/savevalues/c3/saveaa7isa/<?= $code?>/<?= $mtID?>/<?= $cID?>/<?= $name?>" method="post">
                    ...
                    <br><br><br><hr style="color: #7752FE;">
                    <form action="<?= base_url()?>auditsystem/cluster/savevalues/c3/saveaa7aep/<?= $code?>/<?= $mtID?>/<?= $cID?>/<?= $name?>" method="post">
