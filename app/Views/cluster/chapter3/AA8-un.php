        ...
        <div class="card">
            ...
            <div class="card-body">
                <nav class="nav nav-borders">
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'AA8-un')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c3/AA8-un/<?= $mtID?>/<?= $cID?>/<?= $name?>">Unadjusted Errors</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'AA8-ad')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c3/AA8-ad/<?= $mtID?>/<?= $cID?>/<?= $name?>">Adjustments Made</a>
                </nav>
                ...
                <div class="m-5">
                    ...
                    <form action="<?= base_url()?>auditsystem/cluster/savevalues/c3/saveaa11ue/<?= $code?>/<?= $mtID?>/<?= $cID?>/<?= $name?>" method="post">
                    ...
                    <form action="<?= base_url()?>auditsystem/cluster/savevalues/c3/saveaa11un/<?= $code?>/<?= $mtID?>/<?= $cID?>/<?= $name?>" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="yesno[]" id="" class="form-select yesno">
                                                <option value="<?= $r['field7']?>"><?= $r['field7']?></option>
                    ...
                    <br><br><br><hr style="color: #7752FE;">
                    <form action="<?= base_url()?>auditsystem/cluster/savevalues/c3/saveaa11con/<?= $code?>/<?= $mtID?>/<?= $cID?>/<?= $name?>" method="post">
                        ...
                        <table class="table table-bordered table-sm" id="myTable">
                            <thead>
                                <tr>
                                    <th></th>
                                    <th></th>
                                    <th colspan="3">Potential Effect on the Financial Statements</th>
                                    <th></th>
                                </tr>
                                <tr>
                                    <th></th>
