        ...
        <div class="card">
            ...
            <div class="card-body">
                <nav class="nav nav-borders">
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Tangibles')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c2/<?= $code?>-Tangibles/<?= $mtID; ?>/<?= $cID?>/<?= $name?>">Tangibles</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'PPE')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c2/<?= $code?>-PPE/<?= $mtID; ?>/<?= $cID?>/<?= $name?>">PPE</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Investments')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c2/<?= $code?>-Investments/<?= $mtID; ?>/<?= $cID?>/<?= $name?>">Investments</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Inventory')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c2/<?= $code?>-Inventory/<?= $mtID; ?>/<?= $cID?>/<?= $name?>">Inventory</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Trade%20Receivables')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c2/<?= $code?>-Trade Receivables/<?= $mtID; ?>/<?= $cID?>/<?= $name?>">Trade Receivables</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Other%20Receivables')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c2/<?= $code?>-Other Receivables/<?= $mtID; ?>/<?= $cID?>/<?= $name?>">Other Receivables</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Bank%20and%20Cash')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c2/<?= $code?>-Bank and Cash/<?= $mtID; ?>/<?= $cID?>/<?= $name?>">Bank and Cash</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Trade%20Payables')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c2/<?= $code?>-Trade Payables/<?= $mtID; ?>/<?= $cID?>/<?= $name?>">Trade Payables</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Other%20Payables')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c2/<?= $code?>-Other Payables/<?= $mtID; ?>/<?= $cID?>/<?= $name?>">Other Payables</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Provisions')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c2/<?= $code?>-Provisions/<?= $mtID; ?>/<?= $cID?>/<?= $name?>">Provisions</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Revenue')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c2/<?= $code?>-Revenue/<?= $mtID; ?>/<?= $cID?>/<?= $name?>">Revenue</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Costs')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c2/<?= $code?>-Costs/<?= $mtID; ?>/<?= $cID?>/<?= $name?>">Costs</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Payroll')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c2/<?= $code?>-Payroll/<?= $mtID; ?>/<?= $cID?>/<?= $name?>">Payroll</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Summary')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/cluster/setvalues/c2/<?= $code?>-Summary/<?= $mtID; ?>/<?= $cID?>/<?= $name?>">Summary</a>
                </nav>
                <hr style="color: #7752FE;" class="mt-0 mb-4" />
                <a class="btn btn-primary btn-sm float-end mb-2" href="<?= base_url('auditsystem/client/chapter2/view/')?><?= $code?>-Summary/<?= $mtID?>" target="_blank" title="View"><i class="fas fa-eye"></i> View Document</a>
                <div class="m-5">
                    <h4>AUDIT APPROACH AND SAMPLE SIZE CALCULATION</h4>
                    <div class="table-responsive">
                        <form action="<?= base_url()?>auditsystem/cluster/savevalues/c2/saveac10summ/<?= $code?>-<?= $sheet?>/<?= $mtID?>/<?= $cID?>/<?= $name?>" method="post">
                            <table class="table table-bordered table-sm" style="width: 2000px;">
                                ...
                                <tbody id="tbody">
                                    ...
                                    <tr>
                                        <td>Materiality </td>
                                        <td><input name="materiality" type="text" class="form-control form-control-sm" value="<?= $mat['field1']?>"></td>
                                    </tr>
                                </tbody>   
                            </table>
                        </div>
