                ...
                <form class="form-inline" action="<?= base_url()?>auditsystem/client/saveaa4/<?= $code?>/<?= $c3tID?>/<?= $cID?>/<?= $name?>" method="post">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-8">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="small mb-1" for="leg1">We confirm that the following representations are made on the basis of enquiries of management and staff with relevant knowledge and experience and where appropriate, of inspection of supporting documentation, sufficient to satisfy ourselves that we can properly make each of the following representations to you in connection with your audit of the company's financial statements for the year ended [date].</label>
                                    <label class="small mb-1" for="leg2">We acknowledge our legal responsibilities regarding disclosure of information to you as auditors and confirm that so far as we are aware, there is no relevant audit information needed by you in connection with preparing your audit report of which you are unaware.  Each director has taken all the steps that they ought to have taken as a director in order to make themselves aware of any relevant audit information and to establish that you are aware of that information.</label>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="small mb-1">4.	We have disclosed all known or possible litigation and claims whose effects should be considered when preparing the financial statements and these have been disclosed in accordance with the requirements of accounting standards.</label>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="small mb-1" for="num7">7.</label>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="small mb-1">8.	We confirm that we have agreed the adjustments appended to this letter which have been made to the performance statement(s), and statement of financial position which we presented to you for audit.</label>
                                    <label class="small mb-1">9.	We confirm we have no plans or intentions that may materially affect the carrying value or classification of any assets and liabilities reflected in the financial statements.</label>
                                </div>
                            </div>
                            <hr>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="small mb-1" for="num10yes">The following three paragraphs should only be included where applicable:</label>
                                    ...
                                    <div class="form-check mb-2">
                                        <textarea class="form-control form-control-sm" name="num11" id="num11yes" cols="30" rows="5" placeholder="Insert prior period adjustment"><?php if($aa4['num11yes'] != ''){echo $aa4['num11'];}?></textarea>
                                    </div>
                                    ...
                                    <div class="form-check mb-2">
                                        <textarea class="form-control form-control-sm" name="num12" id="num12yes" cols="30" rows="5" placeholder="Insert additional representations"><?php if($aa4['num12yes'] != ''){echo $aa4['num12'];}?></textarea>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="small mb-1">13.	All the accounting records have been made available to you for the purpose of your audit and all the transactions undertaken by the company have been properly reflected and recorded in the accounting records.  We have provided to you all other information requested and given unrestricted access to persons within the entity from whom you have deemed it necessary to speak to.  All other records and relevant information, including minutes of all management and shareholders' meetings, have been made available to you.</label>
                                    <label class="small mb-1">14.	Other than those disclosed in the financial statements we are not aware of any material liabilities, provisions, contingent liabilities, contingent assets or contracted for capital commitments, that need to be provided for or disclosed in the financial statements.</label>
                                </div>
                            </div>
                            <hr>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <div class="form-check mb-2">
                                        <label class="small mb-1" for="num222">List additional non-audit services now provided:</label>
                                        <textarea class="form-control form-control-sm" name="num222" id="num222" cols="30" rows="5" placeholder="Insert List additional non-audit services now provided"><?php if($aa4['num22yes2'] != ''){echo $aa4['num222'];}?></textarea>
                                    </div>
                                    <div class="form-check mb-2">
                                        <label class="small mb-1" for="num223">List any change to the member of informed management:</label>
                                        <textarea class="form-control form-control-sm" name="num223" id="num223" cols="30" rows="5" placeholder="Insert List any change to the member of informed management"><?php if($aa4['num22yes2'] != ''){echo $aa4['num223'];}?></textarea>
                                    </div>
                                    <div class="form-check mb-2">
                                        <label class="small mb-1" for="num224">List any change to interests held in the client’s shares:</label>
                                        <textarea class="form-control form-control-sm" name="num224" id="num224" cols="30" rows="5" placeholder="Insert List any change to interests held in the client’s shares"><?php if($aa4['num22yes2'] != ''){echo $aa4['num224'];}?></textarea>
                                    </div>
                                </div>
                            </div>
                            <hr>
