        ...
        <div class="card">
            ...
            <div class="card-body">
                <nav class="nav nav-borders">
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Tangibles')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/client/chapter1/setvalues/<?= $code?>-Tangibles/<?= $c1tID; ?>/<?= $cID?>/<?= $name?>">Tangibles</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'PPE')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/client/chapter1/setvalues/<?= $code?>-PPE/<?= $c1tID; ?>/<?= $cID?>/<?= $name?>">PPE</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Investments')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/client/chapter1/setvalues/<?= $code?>-Investments/<?= $c1tID; ?>/<?= $cID?>/<?= $name?>">Investments</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Inventory')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/client/chapter1/setvalues/<?= $code?>-Inventory/<?= $c1tID; ?>/<?= $cID?>/<?= $name?>">Inventory</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Trade%20Receivables')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/client/chapter1/setvalues/<?= $code?>-Trade Receivables/<?= $c1tID; ?>/<?= $cID?>/<?= $name?>">Trade Receivables</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Other%20Receivables')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/client/chapter1/setvalues/<?= $code?>-Other Receivables/<?= $c1tID; ?>/<?= $cID?>/<?= $name?>">Other Receivables</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Bank%20and%20Cash')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/client/chapter1/setvalues/<?= $code?>-Bank and Cash/<?= $c1tID; ?>/<?= $cID?>/<?= $name?>">Bank and Cash</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Trade%20Payables')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/client/chapter1/setvalues/<?= $code?>-Trade Payables/<?= $c1tID; ?>/<?= $cID?>/<?= $name?>">Trade Payables</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Other%20Payables')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/client/chapter1/setvalues/<?= $code?>-Other Payables/<?= $c1tID; ?>/<?= $cID?>/<?= $name?>">Other Payables</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Provisions')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/client/chapter1/setvalues/<?= $code?>-Provisions/<?= $c1tID; ?>/<?= $cID?>/<?= $name?>">Provisions</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Revenue')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/client/chapter1/setvalues/<?= $code?>-Revenue/<?= $c1tID; ?>/<?= $cID?>/<?= $name?>">Revenue</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Costs')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/client/chapter1/setvalues/<?= $code?>-Costs/<?= $c1tID; ?>/<?= $cID?>/<?= $name?>">Costs</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Payroll')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/client/chapter1/setvalues/<?= $code?>-Payroll/<?= $c1tID; ?>/<?= $cID?>/<?= $name?>">Payroll</a>
                    <a class="nav-link ms-0 <?php if(str_contains(uri_string(), 'Summary')){echo 'active ';} ?>" href="<?= base_url()?>auditsystem/client/chapter1/setvalues/<?= $code?>-Summary/<?= $c1tID; ?>/<?= $cID?>/<?= $name?>">Summary</a>
                </nav>
                <hr style="color: #7752FE;" class="mt-0 mb-4" />
                <a class="btn btn-primary btn-sm float-end mb-2" href="<?= base_url('auditsystem/client/chapter1/view/')?><?= $code?>-Summary/<?= $c1tID?>" target="_blank" title="View"><i class="fas fa-eye"></i> View Document</a>
                <div class="m-5">
                    <h4>AUDIT APPROACH AND SAMPLE SIZE CALCULATION</h4>
                    <div class="table-responsive">
                        <form action="<?= base_url()?>auditsystem/client/savevalues/c1/saveac10summ/<?= $code?>-<?= $sheet?>/<?= $c1tID?>/<?= $cID?>/<?= $name?>" method="post">
