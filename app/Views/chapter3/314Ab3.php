        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table table-bordered table-sm">
                    ...
                    <tbody>
                        <tr>
                            <td><input type="text" class="form-control form-control-sm" name="frs1" value="<?= $ab3['frs1']?>"></td>
                            <td><input type="text" class="form-control form-control-sm" name="ed1" value="<?= $ab3['ed1']?>"></td>
                        </tr>
                        <tr>
                            <td><input type="text" class="form-control form-control-sm" name="frs2" value="<?= $ab3['frs2']?>"></td>
                            <td><input type="text" class="form-control form-control-sm" name="ed2" value="<?= $ab3['ed2']?>"></td>
                        </tr>
                        <tr>
                            <td><input type="text" class="form-control form-control-sm" name="frs3" value="<?= $ab3['frs3']?>"></td>
                            <td><input type="text" class="form-control form-control-sm" name="ed3" value="<?= $ab3['ed3']?>"></td>
                        </tr>
                        <tr>
                           <td><input type="text" class="form-control form-control-sm" name="frs4" value="<?= $ab3['frs4']?>"></td>
                           <td><input type="text" class="form-control form-control-sm" name="ed4" value="<?= $ab3['ed4']?>"></td>
                        </tr>
                        <tr>
                            <td><input type="text" class="form-control form-control-sm" name="frs5" value="<?= $ab3['frs5']?>"></td>
                            <td><input type="text" class="form-control form-control-sm" name="ed5" value="<?= $ab3['ed5']?>"></td>
                        </tr>
                    </tbody>
                </table>
