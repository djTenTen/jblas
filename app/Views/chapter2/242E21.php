            ...
            <div class="card-body">
                ...
                <form action="<?= base_url()?>auditsystem/c2/aicpppa/save/<?= $code?>/<?= $header?>/<?= $c2tID?>" method="post">
                    <table class="table table-sm table-bordered table-hover">
                        <thead>
                            <tr>
                                <th>Audit Tests – Attendance at Inventory Count – Planning Procedures Prior to Attending </th>
                ...
                <form action="<?= base_url()?>auditsystem/c2/rcicp/save/<?= $code?>/<?= $header?>/<?= $c2tID?>" method="post">
                    <table class="table table-sm table-bordered table-hover">
                        <thead>
                            <tr>
                                <th>Do the inventory count procedures cover:</th>
                                <th>Yes/No/N/A</th>
                                <th>Comments/ Reference</th>
                                <th>status</th>
                                <th>Action</th>
...
$(document).ready(function () {
    ...
    $('#add-field2').on('click', function () {
        ...
        <tr>
            <td><textarea class="form-control question" id="question" cols="30" rows="5" name="question[]"></textarea></td>
            <td><textarea class="form-control question" id="question" cols="30" rows="5" name="yesno[]"></textarea></td>    
            <td><textarea class="form-control question" id="question" cols="30" rows="5" name="comment[]"></textarea></td>
            <td></td>
