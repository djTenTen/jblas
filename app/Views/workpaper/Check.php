                    ...
                    <?php 
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php }?>
                                <a class="btn btn-secondary btn-icon btn-sm get-data" title="Set values" type="button" href="<?= base_url('auditsystem/wp/getfiles/')?><?= encr($r['client'])?>/<?= encr($r['wpID'])?>/<?= $r['cli']?>"><i class="fas fa-highlighter"></i></a>
                                <?php if($p == 100){?>
                                    <button class="btn btn-warning btn-icon btn-sm sendtoreviewer" type="button" data-file="<?= 'FY-'.$r['financial_year'].': '.$r['cli']?>" data-urlsubmit="<?= base_url('auditsystem/wp/sendbacktoreviewer/')?><?= encr($r['wpID'])?>" data-bs-toggle="modal" data-bs-target="#sendtoauditor" title="Send to Reviewer"><i class="fas fa-undo"></i></button>
                                    <button class="btn btn-success btn-icon btn-sm sendtomanager" type="button" data-file="<?= 'FY-'.$r['financial_year'].': '.$r['cli']?>" data-urlsubmit="<?= base_url('auditsystem/wp/approve/')?><?= encr($r['wpID'])?>" data-bs-toggle="modal" data-bs-target="#sendtoauditor" title="Send to Manager"><i class="fas fa-thumbs-up"></i></button>
                                <?php }?>
                            </td>
                        </tr>
                    <?php }?>
