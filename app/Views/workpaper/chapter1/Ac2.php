        ...
        <div class="card">
            ...
            <a class="btn btn-primary btn-sm float-end mb-2" href="<?= base_url('auditsystem/wp/viewpdfc1/')?><?= $code?>/<?= $c1tID?>/<?= $cID?>/<?= $wpID?>" target="_blank" title="View"><i class="fas fa-eye"></i> View Document</a>
                ...
                <div class="m-5">
                    ...
                    <form action="<?= base_url()?>auditsystem/wp/savevalues/c1/saveac2/<?= $code?>/<?= $c1tID?>/<?= $cID?>/<?= $wpID?>/<?= $name?>" method="post">
                    ...
                    <div class="container border-dark">
                        ...
                        <form action="<?= base_url()?>auditsystem/wp/savevalues/c1/saveac2aep/<?= $code?>/<?= $c1tID?>/<?= $cID?>/<?= $wpID?>/<?= $name?>" method="post">
