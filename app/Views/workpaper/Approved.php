                    ...
                    <?php 
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-secondary btn-icon btn-sm" href="<?= base_url('auditsystem/wp/generatepdf/')?><?= encr($r['client'])?>/<?= encr($r['wpID'])?>/<?= $r['cli']?>/<?= $r['aud']?>/<?= $r['sup']?>/<?= $r['audm']?>/<?= $r['financial_year']?>/<?= $r['end_financial_year']?>" target="_blank" title="Generate PDF"><i class="fas fa-file-pdf"></i></a>
                            </td>
                        </tr>
                    <?php }?>
                </tbody>
