        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe src="<?= base_url()?>uploads/pdf/<?= $crypt->decrypt(str_ireplace(['~','$'],['/','+'],$cfiID))?>-<?= $crypt->decrypt(str_ireplace(['~','$'],['/','+'],$cID))?>-<?= $crypt->decrypt(str_ireplace(['~','$'],['/','+'],$wpID))?>-<?= $crypt->decrypt(str_ireplace(['~','$'],['/','+'],$index))?>.pdf" type="application/pdf" frameborder="0" width="100%" height="1000"> </iframe>
