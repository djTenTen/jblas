        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="m-5">
                    ...
                    <form action="<?= base_url()?>auditsystem/wp/savevalues/c3/saveplaf/<?= $code?>/<?= $c3tID?>/<?= $cID?>/<?= $wpID?>/<?= $name?>" method="post">
                    ...
                    <form action="<?= base_url()?>auditsystem/wp/savevalues/c3/saverceap/<?= $code?>/<?= $c3tID?>/<?= $cID?>/<?= $wpID?>/<?= $name?>" method="post">
                    ...
                    <br><br><br><hr style="color: #7752FE;">
                    <form action="<?= base_url()?>auditsystem/wp/savevalues/c3/saveaa1s3/<?= $code?>/<?= $c3tID?>/<?= $cID?>/<?= $wpID?>/<?= $name?>" method="post">
