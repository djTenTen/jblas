            ...
            <form action="<?= base_url()?>auditsystem/c1/saveac9/<?= $code?>/<?= $header?>/<?= $c1tID?>" method="post">
                ...
                <p>I have reviewed, and this has been documented by myself as E.Q.R., the Acceptance or Continuance Form.  I have also reviewed the remaining documents set out in the bullet points above, along with this Assignment Plan, and additionally, the following:</p>
                    <ul>
                        <li>
                            <div class="col-4">
                                <input type="text" class="form-control border-dark" name="aop1" value="<?= $ac9['aop1']?>">
                            </div>
                        </li>
                        <li>
                            <div class="col-4">
                                <input type="text" class="form-control border-dark" name="aop2" value="<?= $ac9['aop2']?>">
                            </div>
                        </li>
                    </ul>
                ...
                <table class="table table-bordered">
                    <tr>
                        <td>
                            ...
                            <p>The principal activities of the entity are [ 
                                <div class="col-4">
                                    <input type="text" class="form-control border-dark" name="bipa" value="<?= $ac9['bipa']?>"> 
                                </div>
                            ]</p>
                            <p>The business objectives and strategies of the entity are  [
                                <div class="col-4">
                                    <input type="text" class="form-control border-dark" name="bibo" value="<?= $ac9['bibo']?>"> 
                                </div>
                            ]</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <textarea class="form-control border-dark" cols="30" rows="20" name="sffpa" placeholder="This should not repeat information included elsewhere."><?= $ac9['sffpa']?></textarea>
                            <br>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <textarea class="form-control border-dark" cols="30" rows="20" name="sosdd" placeholder="This should not repeat information included elsewhere."><?= $ac9['sosdd']?></textarea>
                            <br>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <textarea class="form-control border-dark" cols="30" rows="20" name="klar" placeholder="This should be an “Executive Summary”"><?= $ac9['klar']?></textarea>
                            <br>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <textarea class="form-control border-dark" cols="30" rows="20" name="rpi" placeholder="This should be an “Executive Summary”."><?= $ac9['rpi']?></textarea>
                            <br>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <textarea class="form-control border-dark" cols="30" rows="20" name="soae"><?= $ac9['soae']?></textarea>
                                <br>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <textarea class="form-control border-dark" cols="30" rows="20" name="aa1"><?= $ac9['aa1']?></textarea>
                            ...
                            <textarea class="form-control border-dark" cols="30" rows="20" name="aa2"><?= $ac9['aa2']?></textarea>
                                <br>
                        </td>
                    </tr>
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <textarea class="form-control border-dark" cols="30" rows="20" name="frfa"><?= $ac9['frfa']?></textarea>
                            <br>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <textarea class="form-control border-dark" cols="30" rows="20" name="orr"><?= $ac9['orr']?></textarea>
                                <br>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <textarea class="form-control border-dark" cols="30" rows="20" name="tsr"><?= $ac9['tsr']?></textarea>
                                <br>
                    </td>
                    </tr>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="date" name="cppm" id="" class="form-control border-dark" value="<?= $ac9['cppm']?>">
                            </td>
                        </tr>
                        <tr>
                            <td>Inventory Count (irrespective of whether undertaken by client or 3rd party professional)</td>
                            <td>
                                <input type="date" name="ic" id="" class="form-control border-dark" value="<?= $ac9['ic']?>">
                            </td>
                        </tr>
                        <tr>
                            <td>Audit Fieldwork</td>
                            <td>
                                <input type="date" name="af" id="" class="form-control border-dark" value="<?= $ac9['af']?>">
                            </td>
                        </tr>
                        <tr>
                            <td>Client Closing Meeting</td>
                            <td>
                                <input type="date" name="ccm" id="" class="form-control border-dark" value="<?= $ac9['ccm']?>">
                            </td>
                        </tr>
                        <tr>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" name="bcl1" id="" class="form-control border-dark" value="<?= $ac9['bcl1']?>"></td>
                            <td><input type="date" name="bcl2" id="" class="form-control border-dark" value="<?= $ac9['bcl2']?>"></td>
                        </tr>
                        <tr>
                            <td>Independent Inventory Counter’s Report</td>
                            <td><input type="text" name="iic1" id="" class="form-control border-dark" value="<?= $ac9['iic1']?>"></td>
                            <td><input type="date" name="iic2" id="" class="form-control border-dark" value="<?= $ac9['iic2']?>"></td>
                        </tr>
                        <tr>
                            <td>Receivables’ Circularisation</td>
                            <td><input type="text" name="rc1" id="" class="form-control border-dark" value="<?= $ac9['rc1']?>"></td>
                            <td><input type="date" name="rc2" id="" class="form-control border-dark" value="<?= $ac9['rc2']?>"></td>
                        </tr>
                        <tr>
                            <td>Type 2 Report</td>
                            <td><input type="text" name="t2r1" id="" class="form-control border-dark" value="<?= $ac9['t2r1']?>"></td>
                            <td><input type="date" name="t2r2" id="" class="form-control border-dark" value="<?= $ac9['t2r2']?>"></td>
                        </tr>
                        <tr>
                            <td>Property Valuations</td>
                            <td><input type="text" name="pv1" id="" class="form-control border-dark" value="<?= $ac9['pv1']?>"></td>
                            <td><input type="date" name="pv2" id="" class="form-control border-dark" value="<?= $ac9['pv2']?>"></td>
                        </tr>
                        <tr>
                            <td>Valuations of Financial Instruments</td>
                            <td><input type="text" name="vfi1" id="" class="form-control border-dark" value="<?= $ac9['vfi1']?>"></td>
                            <td><input type="date" name="vfi2" id="" class="form-control border-dark" value="<?= $ac9['vfi2']?>"></td>
                        </tr>
                        <tr>
                            <td>Actuarial Valuations</td>
                            <td><input type="text" name="av1" id="" class="form-control border-dark" value="<?= $ac9['av1']?>"></td>
                            <td><input type="date" name="av2" id="" class="form-control border-dark" value="<?= $ac9['av2']?>"></td>
                        </tr>
                        <tr>
                            <td>Legal Opinions</td>
                            <td><input type="text" name="lo1" id="" class="form-control border-dark" value="<?= $ac9['lo1']?>"></td>
                            <td><input type="date" name="lo2" id="" class="form-control border-dark" value="<?= $ac9['lo2']?>"></td>
                        </tr>
                    </tbody>
                </table>
