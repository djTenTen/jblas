                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><textarea class="form-control border-dark" cols="30" rows="5" name="dcfrrt1"><?= $ac11['dcfrrt1']?></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea class="form-control border-dark" cols="30" rows="5" name="dcfrrt2"><?= $ac11['dcfrrt2']?></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea class="form-control border-dark" cols="30" rows="5" name="dcfrrt3"><?= $ac11['dcfrrt3']?></textarea></td>
                        </tr>
                        <tr>
                            <td>4.	How a fraud could be carried out by customers or suppliers;</td>
                            <td><textarea class="form-control border-dark" cols="30" rows="5" name="dcfrrt4"><?= $ac11['dcfrrt4']?></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea class="form-control border-dark" cols="30" rows="5" name="dcfrrt5"><?= $ac11['dcfrrt5']?></textarea></td>
                        </tr>
                        <tr>
                            <td colspan="2">Scope of discussion (add additional points as appropriate) ~ note that all points should be discussed, and key issues highlighted below:</td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea class="form-control border-dark" cols="30" rows="5" name="dcfrrt6"><?= $ac11['dcfrrt6']?></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea class="form-control border-dark" cols="30" rows="5" name="dcfrrt7"><?= $ac11['dcfrrt7']?></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea class="form-control border-dark" cols="30" rows="5" name="dcfrrt8"><?= $ac11['dcfrrt8']?></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea class="form-control border-dark" cols="30" rows="5" name="dcfrrt9"><?= $ac11['dcfrrt9']?></textarea></td>
                        </tr>
                    </tbody>
                </table>
                <br>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="text" class="form-control border-dark" name="sacb1" <?= $ac11['sacb1']?>></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" class="form-control border-dark" name="sacb2" value="<?= $ac11['sacb2']?>"></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" class="form-control border-dark" name="sacb3" value="<?= $ac11['sacb3']?>"></td>
                        </tr>
                        <tr>
                            <td>- That if new related parties are identified, these must be communicated immediately to all members of the audit team;</td>
                            <td><input type="text" class="form-control border-dark" name="sacb4" value="<?= $ac11['sacb4']?>"></td>
                        </tr>
                        <tr>
                            <td>2.	The responsibilities of team members have been clarified and documented at Ac14;</td>
                            <td><input type="text" class="form-control border-dark" name="sacb5" value="<?= $ac11['sacb5']?>"></td>
                        </tr>
                        <tr>
                            <td>3.	A detailed briefing regarding the client (including; objectives, structure and activities);</td>
                            <td><input type="text" class="form-control border-dark" name="sacb6" value="<?= $ac11['sacb6']?>"></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" class="form-control border-dark" name="sacb7" value="<?= $ac11['sacb7']?>"></td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" class="form-control border-dark" name="sacb8" value="<?= $ac11['sacb8']?>"></td>
                        </tr>
                        <tr>
