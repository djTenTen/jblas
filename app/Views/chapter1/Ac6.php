...
<script>
    $(document).ready(function () {
        ...
        $('#add-field1').on('click', function () {
            // Adding a row inside the tbody.
            $('#tbody1').append(`<tr>
                            <td><textarea class="form-control" name="" id="financialstatement[]" cols="30" rows="10"></textarea> </td>
                            <td><textarea class="form-control" name="" id="descriptioncontrol[]" cols="30" rows="10"></textarea> </td>
                            <td><textarea class="form-control" name="" id="controleffective[]" cols="30" rows="10"></textarea> </td>
                            <td><textarea class="form-control" name="" id="controlimplemented[]" cols="30" rows="10"></textarea> </td>
                            <td><textarea class="form-control" name="" id="assesed[]" cols="30" rows="10"></textarea> </td>
                            <td><textarea class="form-control" name="" id="crosstesting[]" cols="30" rows="10"></textarea> </td>
                            <td><textarea class="form-control" name="" id="reliancecontrol[]" cols="30" rows="10"></textarea> </td>
                        </tr>`);
        });
